...
export const OPENING_OPTIONS: Record<ProdType, string[]> = {
  door: [
    ...
    '3 молнии(спираль) + поворотная скоба (низ)',
    '3 молнии(спираль) + французский замок (низ)',
    '4 молнии(спираль) + поворотная скоба (низ)',
    '4 молнии(спираль) + французский замок (низ)',
    '5 молний(спираль) + поворотная скоба (низ)',
    '5 молний(спираль) + французский замок (низ)',
    // legacy values kept for existing orders
